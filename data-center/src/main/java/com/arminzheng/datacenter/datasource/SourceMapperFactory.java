package com.arminzheng.datacenter.datasource;

import com.arminzheng.datacenter.constant.DataSourceConst;
...
public class SourceMapperFactory {
    ...
    public SourceMapper createSourceMapper() {
        ...
        for (Map.Entry<String, String> entry : sqlMap.entrySet()) {
            mappedStatementFactory.createMappedStatement(entry.getKey(), entry.getValue());
